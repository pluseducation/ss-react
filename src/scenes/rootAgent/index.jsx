...
const RootAgent = () => {
        ...
        if (id) {
            try {
                axiosPrivate.get('/root-agent/view-rootagent-byId/' + id).then(res => {
                    ...
                    root_agent_username_page = res.data.data[0].root_agent_username_page;
                    ...
                    setValue({ id, root_agent_name, root_agent_username, root_agent_username_page, root_agent_password
                        , bank_id, root_agent_api_endpoint, root_agent_api_client_name, root_agent_api_hash, root_agent_api_key, status});
                });
            } catch (err) {
                console.error(err);
            }
    ...
    return (
        <Box m={2} >
            <Header title={translate("rootagent_title")} subtitle={translate("rootagent_description")} />
